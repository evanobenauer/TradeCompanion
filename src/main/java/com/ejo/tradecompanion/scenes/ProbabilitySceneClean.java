...
public class ProbabilitySceneClean extends Scene {
    ...
    public void onKeyPress(int key, int scancode, int action, int mods) {
        ...
        if (key == Key.KEY_C.getId()) {
            ...
            similarCandles = getSimilarCandleIDs(stock,time,.05f,true);
        }
    ...
    private ArrayList<Long> getSimilarCandleIDs(Stock stock, DateTime candleTime, float marginPrice, boolean doPriceScaling) {
        ...
        System.out.println("Candles Found: " + similarCandleCount);
    ...
    private boolean areCandlesSimilar(float[] mainData, float[] testData, float marginPrice, float pricingScale) {
        ...
        //TODO: Maybe use a method that adds all the variation together into one total that has to be below a max percent
    ...
    //TODO: create this method, finish parameters
    private ArrayList<Long> getLayeredSimilarCandleIDs(ArrayList<Long> similarCandleIDs) {
        return null;
    }
